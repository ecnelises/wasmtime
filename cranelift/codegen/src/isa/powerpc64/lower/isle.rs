//! ISLE integration glue code for powerpc64 lowering.
...
use crate::isa;
use crate::isa::powerpc64::inst::{FPULeftShiftImm, FPURightShiftImm, ReturnCallInfo};
use crate::isa::powerpc64::AArch64Backend;
...
use crate::{
    ...
    isa::powerpc64::abi::AArch64CallSite,
    isa::powerpc64::inst::args::{ShiftOp, ShiftOpShiftImm},
    isa::powerpc64::inst::SImm7Scaled,
...
impl Context for IsleContext<'_, '_, MInst, AArch64Backend> {
    ...
    isle_prelude_caller_methods!(
        crate::isa::powerpc64::abi::AArch64MachineDeps,
        AArch64CallSite
    );
