//! PowerPC 64-bit architecture (little-endian only)

use crate::dominator_tree::DominatorTree;
use crate::ir::{Function, Type};
use crate::isa::powerpc64::settings as powerpc64_settings;
#[cfg(feature = "unwind")]
...
impl PPC64Backend {
    ...
    fn compile_vcode(
        ...
        compile::compile::<PPC64Backend>(func, domtree, self, abi, emit_info, sigs, ctrl_plane)
    }
}
...
impl TargetIsa for PPC64Backend {
    ...
    fn emit_unwind_info(
        ...
        Ok(match kind {
            ...
            UnwindInfoKind::Windows => {
                // TODO: support Windows unwind info on PPC64
                None
            }
            _ => None,
        })
    ...
    fn to_capstone(&self) -> Result<capstone::Capstone, capstone::Error> {
        ...
        let mut cs = Capstone::new()
            ...
            .build()?;
        // PPC64 uses inline constants rather than a separate constant pool right now.
...
pub fn isa_builder(triple: Triple) -> IsaBuilder {
    ...
    IsaBuilder {
        triple,
        setup: powerpc64_settings::builder(),
        constructor: |triple, shared_flags, builder| {
            let isa_flags = powerpc64_settings::Flags::new(&shared_flags, builder);
